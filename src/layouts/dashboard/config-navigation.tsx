      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          // BLOG
          {
            ...
            icon: ICONS.blog,
            children: [
              { title: t('一覧'), path: paths.dashboard.post.root },
              { title: t('詳細'), path: paths.dashboard.post.demo.details },
              { title: t('投稿'), path: paths.dashboard.post.new },
              { title: t('編集'), path: paths.dashboard.post.demo.edit },
            ],
          },
